...
class CompanyGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Company entity")
        ...
        .repeat(2) {
            ...
            .post("/api/companies")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "workTitle":"SAMPLE_TEXT", "workDescription":"SAMPLE_TEXT", "location":"SAMPLE_TEXT", "startDate":"2020-01-01T00:00:00.000Z", "website":"SAMPLE_TEXT", "tel":null, "employerRange":"SAMPLE_TEXT", "email":"SAMPLE_TEXT", "about":"SAMPLE_TEXT", "socialNetworks":"SAMPLE_TEXT", "vacancies":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
