...
class ProjectGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Project entity")
        ...
        .repeat(2) {
            ...
            .post("/api/projects")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "startDate":"2020-01-01T00:00:00.000Z", "endDate":"2020-01-01T00:00:00.000Z", "associatedWith":"SAMPLE_TEXT", "projectUrl":"SAMPLE_TEXT", "description":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
