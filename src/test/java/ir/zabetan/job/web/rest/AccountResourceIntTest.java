...
import ir.zabetan.job.domain.Authority;
import ir.zabetan.job.domain.User;
import ir.zabetan.job.repository.AuthorityRepository;
import ir.zabetan.job.repository.UserRepository;
import ir.zabetan.job.security.AuthoritiesConstants;
import ir.zabetan.job.service.MailService;
import ir.zabetan.job.service.dto.UserDTO;
import ir.zabetan.job.service.dto.PasswordChangeDTO;
import ir.zabetan.job.web.rest.errors.ExceptionTranslator;
import ir.zabetan.job.web.rest.vm.KeyAndPasswordVM;
import ir.zabetan.job.web.rest.vm.ManagedUserVM;
import ir.zabetan.job.service.UserService;
